...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/02/06 14:39:35 by mbooth            #+#    #+#             */
/*   Updated: 2015/02/14 16:36:21 by mbooth           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_bool	con_deal_with_specifier(t_format *format,
...
void			deal_with_specifier(t_format *format, t_conversion *conversion)
{
	...
	if (con_deal_with_specifier(format, conversion))
	{
